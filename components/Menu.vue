  ...
  <div style="margin: 20px 8px 0 0">
    <div class="campus-menu" :style="{ height: menuHeight + 'px' }">
      <div>
        ...
        <el-menu style="width: 182px" default-active="1" @select="handleSelectMenu" :unique-opened="true"
          class="el-menu-vertical" background-color="#ffffff" text-color="#000000" active-text-color="#d2691e">
...
.campus-menu {
  ...
  box-shadow: rgba(0, 0, 0, 0.05) 0rem 1.25rem 1.6875rem;
}
span{
